...
author: "Stephanie Kobakian <br> @srkobakian [`r icon::fa_twitter()`](https://twitter.com/srkobakian) <br> Queensland University of Technology <br> Monash University"
output:
...
# Liver cancer across the hexagons
## SIR for females
---
...
# Lung cancer across the hexagons
## SIR for persons
