...
author: "Stephanie Kobakian <br> srkobakian [`r icon::fa_twitter()`](https://twitter.com/srkobakian)[`r icon::fa_github()`](https://github.com/srkobakian) <br> <br> Queensland University of Technology <br> Monash University"
output:
